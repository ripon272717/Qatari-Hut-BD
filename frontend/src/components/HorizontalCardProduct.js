...
const HorizontalCardProduct = ({ category, heading }) => {
    ...
    // Context চেক করা হচ্ছে যাতে null এরর না আসে
...

                {
                    loading ? (
                        loadingList.map((_, index) => (
                            <div key={"loading-"+index} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex animate-pulse'>
                                <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px]'></div>
                                <div className='p-4 grid w-full gap-2'>
                                    <h2 className='font-medium text-base md:text-lg p-1 bg-slate-200 rounded-full'></h2>
